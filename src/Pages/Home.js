...
import HotelSearch from "../Components/TourSeach";
import TourSearch from "../Components/HotelSearch.js";
                ...
                <div className="row">
                  <div className="col-md-12 nav-link-wrap">
                    ...
                    >
                      <a
                        className={
                          searchFilter ? "nav-link active" : "nav-link"
                        }
                        id="v-pills-2-tab"
                        data-toggle="pill"
                        href="#v-pills-2"
                  ...
                  <div className="col-md-12 tab-wrap">
                    <div className="tab-content" id="v-pills-tabContent">
                      {searchFilter ? <TourSearch /> : <HotelSearch />}
                    </div>
                  </div>
                </div>
              </div>
